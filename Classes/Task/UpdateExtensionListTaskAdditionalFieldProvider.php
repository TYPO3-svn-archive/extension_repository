<?php
	 ...
	 */
	class Tx_ExtensionRepository_Task_UpdateExtensionListTaskAdditionalFieldProvider extends Tx_ExtensionRepository_Task_AbstractAdditionalFieldProvider {
		...
		protected function addAdditionalFields() {
			$providers = array();
			if (!empty($GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['extension_repository']['extensionProviders'])) {
				foreach ($GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['extension_repository']['extensionProviders'] as $key => $configuration) {
